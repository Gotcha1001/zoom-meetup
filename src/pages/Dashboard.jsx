            ...
            <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-center'>
                ...
                <div className='lg:col-span-7 space-y-8'>
                    <div className='space-y-3'>
                        ...
                        <p className='text-slate-700 text-base sm:text-lg max-w-xl leading-relaxed'>Connect, Collaborate, and celebrate from anywhere with ultra-low latency video, screen sharing, and real-time chat</p>
                        <div className='flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2'>
                            ...
                            <form className='flex-1 flex items-center gap-2' onSubmit={handleJoinMeeting}>
                                <div className='relative flex-1'>
                                    <KeyboardIcon className='w-5 h-5 text-primary/90 absolute left-4 top-1/2 -translate-y-1/2' />
                                    <input type="text" placeholder='Enter Meeting Code (eg. abc-def-ghi)'
                                ...
                                <button
                                    className='bg-slate-900 hover:bg-slate-800 disabled:opacity-40 disabled:hoverbg-slate-900 text-white font-medium px-6 py-3.5 rounded-full transition-all flex items-center justify-center cursor-pointer shadow-xs'
                ...
                {/* Rigth Column - Hero Graphic and Clock Card */}
                            ...
                            {stats && (
                                <div className='w-full bg-white/50 rounded-2xl px-5 py-4 border border-slate-100'>
                                    <div className='flex items-center justify-between text-sm'>
                                        ...
                                        <span className='text-xs text-slate-600 font-mono'>{stats.monthlyLimit ? `${stats.monthlyCount} / ${stats.monthlyLimit} Used` : `${stats.monthlyCount} Created (Unlimited)`}</span>
                                    </div>
                                </div>
                            )}
                        </div>
