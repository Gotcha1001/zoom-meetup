                    ...
                    return (
                        <div key={p.socketId} className='flex items-center justify-between p-3 rounded-2xl bg-slate-50 border border-slate-200 shadow-xs'>
                            <div className='flex items-center gap-3'>
                                <div className='h-9 w-9 rounded-full bg-primary-light border border-primary-border text-primary font-bold flex items-center justify-center text-sm shadow-xs'>
